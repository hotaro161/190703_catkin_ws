...
#include "../include/img_subscriber2/bebop_controller.hpp"
using namespace cv;
using namespace std;
/***************************main******************************/
int main(int argc, char** argv)
{
    ...
    ros::init (argc, argv, "img_subscriber2");
    ROS_INFO("ok");
    ros::NodeHandle nh;
    ImgData imgData(nh);
    BebopDriver driver(nh);
    image_transport::ImageTransport it(nh);
    image_transport::Subscriber image_sub = it.subscribe("bebop2/image_raw", 10,&ImgData::imageCallback, &imgData);
