...
ImgData::ImgData(ros::NodeHandle &nh){
    ni_ = nh;
    img_data_pub_[0] = ni_.advertise<geometry_msgs::Point>("ImgDataPub0",1);
    img_data_pub_[1] = ni_.advertise<geometry_msgs::Point>("ImgDataPub1",1);
    img_data_pub_[2] = ni_.advertise<geometry_msgs::Point>("ImgDataPub2",1);
    img_data_pub_[3] = ni_.advertise<geometry_msgs::Point>("ImgDataPub3",1);
    //obstacle
    for(int i = 0;i < 5;i++){
        for(int j = 0;j < 4;j++){
            char s[20];
